...
public class MapUbahKec extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_ubah_kec);

        supportMapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.map_editkec);
        supportMapFragment.getMapAsync(this);

        keluar = findViewById(R.id.keluar_mapeditkec);
        simpan = findViewById(R.id.save_editkec);
        ...
        simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (latlang.isEmpty()) {
                    Toast.makeText(MapUbahKec.this, "Titik koordinat belum ada", Toast.LENGTH_SHORT).show();
                } else {
                    String[] point = latlang.split(",");
                    Intent intent = new Intent(MapUbahKec.this, UbahKec.class);
                    intent.putExtra("a", "1");
